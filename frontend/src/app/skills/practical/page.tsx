...
import { getAllPracticalSkills, Skill } from "@/lib/skills";
...
export default function PracticalSkillsPage() {
  ...
  const displayedSkills = allSkills.slice(startIndex, startIndex + ITEMS_PER_PAGE);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">实战技能</h1>
              <p className="text-sm text-gray-500">项目中实际使用的 AI Skill</p>
            </div>
          </div>
          <p className="text-gray-400 max-w-2xl">
            这些技能经过实战验证，在真实项目中得到应用，能够显著提升开发效率和代码质量。
          </p>
        </motion.div>
